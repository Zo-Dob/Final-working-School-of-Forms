...
let swpsDrawTime = null; // Variable to capture the time when SWPS is drawn
...
function draw() {
  ...
  if (stage1 == 1) {
    ...
    for (let i = 0.55; i < 6; i++) {
      square(970, i * 250, 120, 15);
    } // x i y, dlugosc boku

    for (let i = 0.55; i < 6; i++) {
      square(1210, i * 250, 120, 15);
    } // x i y, dlugosc boku

    for (let i = 0.55; i < 6; i++) {
      square(1450, i * 250, 120, 15);
    } // x i y, dlugosc boku
    ...
    if (index < 5) { //change back to 5!!! ////////////////////////////////////////////////////
      ...
      // Capture the time when SWPS is first drawn
      if (swpsDrawTime === null) {
        swpsDrawTime = millis();
      }

      // Check if 15 seconds have passed
      if (millis() - swpsDrawTime >= 12000) {
